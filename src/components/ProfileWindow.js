	                        ...
	                        <div className="row">
	                            <div className="col-md-5">
	                                <div className="profile-info-left">
	                                    ...
	                                    <small className="text-muted">Dept. Gynecology</small> : <small className="text-muted">Gynecologist</small>
	                                    <div className="staff-id">Employee ID : DR-0001</div>
	                                    <div className="staff-msg"><a href="/message/jd10001hash" className="btn btn-primary">Send Message</a></div>
	                                </div>
	                            </div>
